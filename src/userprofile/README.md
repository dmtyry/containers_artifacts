...
docker run -d -p 8081:80 --name userprofile --network huminsnw -e "SQL_PASSWORD=$SQL_PASSWORD" -e "SQL_SERVER=$SQL_SERVER" -e "SQL_USER=$SQL_USER" tripinsights/userprofile:1.0
